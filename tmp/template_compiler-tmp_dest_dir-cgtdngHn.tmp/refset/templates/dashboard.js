...
function program10(depth0,data) {
  ...
  data.buffer.push("\n					<li><a href=\"#\">SNOMED CT Browser</a></li>\n				");
  }

function program12(depth0,data) {
  
  
  data.buffer.push("\n					<li><a href=\"#\">IHTSDO Website</a></li>\n					<li><a href=\"#\">Contact support</a></li>\n				");
  }
...
function program14(depth0,data) {
  ...
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n</div>\n    </div>\n<div class=\"col-md-6 \">\n    <div class=\"most-popular row\">\n<h3> Most Recent Refsets</h3>\n        <div class=\"snomed-heading\">\n            <h4>Snomed CT</h4>\n            </div>\n        <div class=\"refset-details\">\n             <h4>Reference Set Details</h4>\n            </div>\n   </div>\n    \n    <div class=\"most-popular\">\n<h3> Most Popular Refsets</h3>\n        <div class=\"snomed-heading\">\n            <h4>Snomed CT</h4>\n            </div>\n        <div class=\"refset-details\">\n             <h4>Reference Set Details</h4>\n            </div>\n   </div>\n</div>\n<div class=\"col-md-3 dashboard-sidebar\">\n    <h2>Refset Tool News</h2>\n<ul class=\"list-group refset-list news\">\n	");
  stack1 = helpers.each.call(depth0, "news", {hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(14, program14, data),contexts:[depth0],types:["ID"],data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n</ul>\n    \n</div>\n    </div>");
  return buffer;
