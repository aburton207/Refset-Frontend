...
function program71(depth0,data) {
  ...
  stack1 = (helper = helpers.collection || (depth0 && depth0.collection),options={hash:{
    ...
    'rowHeight': ("memberRowHeight"),
    'width': ("100%")
  },hashTypes:{'contentBinding': "STRING",'rowHeight': "ID",'width': "STRING"},hashContexts:{'contentBinding': depth0,'rowHeight': depth0,'width': depth0},inverse:self.noop,fn:self.program(72, program72, data),contexts:[depth0],types:["ID"],data:data},helper ? helper.call(depth0, "Ember.ListView", options) : helperMissing.call(depth0, "collection", "Ember.ListView", options));
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n										  ");
  return buffer;
  }
